#pragma checksum "C:\Users\5cepr\Desktop\Projekti_GK\Music_Player\Music_Player\Views\Home\Artists.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "3a5c6fb93afbc7024b3ce4a9bcfb8f47b56f465e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"3a5c6fb93afbc7024b3ce4a9bcfb8f47b56f465e", @"/Views/Home/Artists.cshtml")]
...
<script type=""text/javascript"">
    ...
    function Show(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            row.appendChi");
            WriteLiteral(@"ld(rowname);
     
            btn.innerHTML = ""Remove"";
            btn.id = `${data[i].id}`;
            btn.addEventListener(""click"", GetAllSongs);
    ...
    function GetAllSongs() {
        ...
        axios.get('/api/song').then(respon");
            WriteLiteral(@"se => GetMatchingIDs(response.data, btnID));
    ...
    function ChangeToNull(data, btn) {
        let song = {
            ...
            ""songname"": data.name,
            ""s");
            WriteLiteral(@"onglength"": data.length,
            ""artist_id"": null
        }
